...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("#vimeo-player"),n=new Vimeo.Player(o),r="videoplayer-current-time";n.on("timeupdate",(0,e.default)(function(e){localStorage.setItem(r,e.seconds)},1e3)),n.setCurrentTime(localStorage.getItem(r)).then(function(e){}).catch(function(e){e.name});
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.a9561706.js.map